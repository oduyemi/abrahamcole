...
export const ContactUs = () => {
    return(
        <>
            <div className="container mb-24 mx-auto md:px-6 contact">
            <section className="mb-14">
                <div
                className="relative h-[220px] overflow-hidden contact_header">
                </div>
                ...
                <div className="block rounded-lg bg-hsla(0, 0%, 100%, 0.7) px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-hsla(0,0%,5%,0.7) dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
                    ...
                    <div className="mx-auto mb-12 text-center lg:mb-0">
                        ...
                        stroke="currentColor" className="mx-auto mb-6 h-8 w-8 text-white">
                    ...
                    <div className="mx-auto mb-12 text-center lg:mb-0">
                        ...
                        <h6 className="font-medium text-white">Birmingham, 94126</h6>
                    </div>
                    <div className="mx-auto mb-6 text-center md:mb-0">
                        ...
                        <h6 className="font-medium text-white">+44 7984 488505</h6>
                    </div>
                    <div className="mx-auto text-center">
                        ...
                        <h6 className="font-medium text-white">Email: info@abrahamcole.co.uk</h6>
                    </div>
                    </div>
                    ...
                    <form>
                        ...
                        <input
                            ...
                            type="checkbox" value="" id="copy" />
                        <label className="inline-block pl-[0.15rem] hover:cursor-pointer text-white" htmlFor="copy">
