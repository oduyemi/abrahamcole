    ...
    return isMobileMenuOpen && (
      <div className="md:hidden">
        ...
        <Link to="/" className="text-l block py-2 hover:text-butter">
          <img src={isWhiteBackground ? sitelogo : sitelogoWhite} alt="logo" className={isWhiteBackground ? "white-logo" : "black-logo"} />
        </Link>
      </div>
    );
  };
      ...
      >
        <div className="mt-0 py-1 flex items-center nav-icon justify-between">
          ...
          <div className="mx-auto logo">
            <Link to="/" className="text-l block py-2">
              <img src={isWhiteBackground ? sitelogo : sitelogoWhite} alt="logo" width="50%" />
            </Link>
          </div>
          <ul className={`nav-menu-wrapper flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-l md:font-medium`} id="mobile-menu">
            <li>
              <Link to="/about" className={`hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-butter md:p-0`}>
                About
              </Link>
            </li>
            <li>
              <Link to="/cv" className={`hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-butter md:p-0`}>
                Curriculum Vitae
              </Link>
            </li>
            <li>
              <Link to="/body-of-works" className={`hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-butter md:p-0`}>
                Body of Works
              </Link>
            </li>
            <li>
              <Link to="/contact" className={`hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-butter md:p-0`}>
                Contact
              </Link>
            </li>
          </ul>
