...
export const Resume = () => {
    return(
        <>
            <div className="">
                <div className="container ms-5 py-8 px-4">
                    <div className="bg-primary p-6 rounded-lg shadow-lg text-white ">
                        ...
                        <ul className="list-disc list-inside text-gray-400">
                            <li className="mb-4">Art Design <span> &emsp; <Link to="#">Yaba College of Technology</Link> &emsp; Nigeria </span> &emsp; 2012</li>
                            <li>General Art <span> &emsp; <Link to="#">Yaba College of Technology</Link> &emsp; Nigeria </span> &emsp; 2007</li>
                        </ul>
                        <h2 className="text-xl font-semibold mt-4 mb-2">Exhibition</h2>
                        <div className="mb-4">
                            <h3 className="text-lg font-semibold">Solo</h3>
                            <p className="text-gray-400">
                                <ul className="list-disc list-inside text-gray-400">
                                    <li className="my-2">Deep Introspection
                                        <span> &emsp; &emsp;
                        ...
                        <h2 className="text-xl font-semibold mt-4 mb-2">Awards</h2>
                        <p className="text-gray-400">
                                <ul className="list-disc list-inside text-gray-400">
